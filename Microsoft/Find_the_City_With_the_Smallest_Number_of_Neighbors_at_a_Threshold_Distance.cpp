...
public:
    ...
    {
        vector<vector<int>> matrix(n, vector<int>(n, 1000000000));
        int city = -1;
        int y = INT_MAX;
        for (int i = 0; i < n; i++)
        {
            ...
            if (i == n - 1)
            {
                for (int j = 0; j < n; j++)
                {
                    ...
                    for (int k = 0; k < n; k++)
                    {
                        ...
                        else if (matrix[j][k] <= distanceThreshold)
                        {
                            ans++;
                        }
                    }
...
int main()
{
    ...
    int ans = ss.findTheCity(n, edges, distanceThreshold);
